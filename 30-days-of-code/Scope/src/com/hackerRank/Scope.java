...
class Scope{
    private boolean b = true; // b1 has scope of entire class
    private int x = 88; // x1 has scope of entire class
    ...
    private void example(double x){ // parameter x2 has scope of this method
